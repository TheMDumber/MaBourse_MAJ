/**
 * Module de journalisation pour Ma Bourse (version TypeScript)
...
/**
 * Classe Logger pour gérer les journaux dans l'application Ma Bourse
 */
class Logger {
   ...
   * @param maxEntries Nombre maximum d'entrées à conserver en mémoire
   * @param level Niveau minimum de journalisation
   */
